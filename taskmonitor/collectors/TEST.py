...
print(f"Opened_file.txt : {'OK' if opened_exists else 'MISSING'}")
print(f"Closed_file.txt : {'OK' if closed_exists else 'MISSING'}")
print(f"collected_file.txt : {'OK' if collected_exists else 'MISSING'}")
print(f"data_file.txt : {'OK' if data_file_exists else 'MISSING'}")